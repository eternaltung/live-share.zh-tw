...
若要共同作業，您必須登入 Visual Studio Live Share 讓每個人都知道您的身分。 **按一下 ** "Live Share"狀態列的項目或按下**Ctrl + Shift + P / Cmd + Shift + P** ，然後選取 「 即時共用：使用瀏覽器登入 」 的命令。

![VS 程式碼登入 按鈕](../media/vscode-sign-in-button.png)

通知會出現要求您登入的啟動時，將會啟動您的瀏覽器。 完成登入您的瀏覽器中的程序，然後只需關閉瀏覽器完成。
...
仍然有問題嗎？ 請參閱[疑難排解](../troubleshooting.md#sign-in)。
